...
#	And el cuerpo de la respuesta .response.nodes[1].id debe existir
#	And el cuerpo de la respuesta .response.nodes[1].id_parent debe existir
#	And el cuerpo de la respuesta .response.nodes[1].code debe existir
#	And el cuerpo de la respuesta .response.nodes[1].text debe existir
#	And el cuerpo de la respuesta .response.nodes[1].menu_id debe existir
#	And el cuerpo de la respuesta .response.nodes[1].image debe existir
#	And el cuerpo de la respuesta .response.nodes[1].image_over debe existir
#	And el cuerpo de la respuesta .response.nodes[1].level debe existir
#	And el cuerpo de la respuesta .response.nodes[1].type debe existir
#	And el cuerpo de la respuesta .response.nodes[1].order debe existir
#	And el cuerpo de la respuesta .response.nodes[1].status debe existir
#	And el cuerpo de la respuesta .response.nodes[1].app_behaviour debe existir
